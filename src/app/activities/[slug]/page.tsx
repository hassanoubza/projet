...
import {getActivityBySlug,getActivitySlugs,} from "@/components/section/activities/activity.data";
import { Check, X } from "lucide-react";
import ContactAdventure from "@/components/ui/ContactAdventure";
import InstagramSection from "@/components/ui/Instgramme";
import ActivityJsonLd from "@/components/seo/ActivityJsonLd";
...
export async function generateMetadata({
  ...
  if (!activity) {
    return {
      ...
      description:
        "This activity could not be found. Explore our full range of Marrakech tours and experiences.",
